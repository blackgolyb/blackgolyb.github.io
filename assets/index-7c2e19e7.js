...
*/(function(e){(function(){var t={}.hasOwnProperty;function n(){for(var i="",u=0;u<arguments.length;u++){var o=arguments[u];o&&(i=l(i,r(o)))}return i}function r(i){if(typeof i=="string"||typeof i=="number")return i;if(typeof i!="object")return"";if(Array.isArray(i))return n.apply(null,i);if(i.toString!==Object.prototype.toString&&!i.toString.toString().includes("[native code]"))return i.toString();var u="";for(var o in i)t.call(i,o)&&i[o]&&(u=l(u,o));return u}function l(i,u){return u?i?i+" "+u:i+u:i}e.exports?(n.default=n,e.exports=n):window.classNames=n})()})(Dc);var Cd=Dc.exports;const Rl=Ts(Cd);function lo(e,t){return Math.floor(Math.random()*(t-e+1))+e}const wd="_terminal_1whad_1",xd="_visible_1whad_24",kd="_cursor_1whad_53",Pd="_blink_1whad_1",Md="_invalid_1whad_65",Od="_valid_1whad_69",Hd="_text_1whad_73",qe={terminal:wd,"input-prefix-span":"_input-prefix-span_1whad_12","input-section":"_input-section_1whad_17",visible:xd,"command-inputted":"_command-inputted_1whad_28","command-input":"_command-input_1whad_28",cursor:kd,blink:Pd,invalid:Md,valid:Od,text:Hd,"help-list":"_help-list_1whad_78"},Dd="~>",Wc=()=>x.jsx("span",{className:qe["input-prefix-span"],children:Dd}),Wd=({command:e,result:t,commandId:n})=>x.jsxs("div",{children:[x.jsxs("p",{className:qe["command-inputted"],children:[x.jsx(Wc,{}),e]}),t]},n),Ud=U.forwardRef((e,t)=>{const[n,r]=U.useState([]),[l,i]=U.useState([]),[u,o]=U.useState(-1),[a,f]=U.useState(-1),[y,g]=U.useState(""),[v,I]=U.useState(""),[A,R]=U.useState(!1),[B,p]=U.useState(!0),c=U.useRef(null),O=[...[{name:"help",run:()=>{let s=[];for(let _=0;_<O.length;_++){const h=O[_];s.push(x.jsxs("li",{children:[h.name,h.description?" - ":"",h.description||""]},_))}return j(),x.jsx("ul",{className:qe["help-list"],children:s})},description:"return a list of all available commands"},{name:"exit",run:()=>{let s=document.createElement("style");const _="*{animation:4s linear 1s forwards glitch,1.5s linear 5s forwards destroy}@keyframes glitch{0%,15%{filter:invert(0)}4%{filter:invert(1)}20%{filter:invert(1);filter:brightness(.5)}26%{filter:invert(0);filter:brightness(1);filter:grayscale(0)}40%{filter:grayscale(1)}79%{filter:grayscale(0);filter:brightness(1)}80%{filter:brightness(0)}100%{filter:brightness(1);filter:invert(0)}}@keyframes destroy{0%{opacity:1}50%{filter:grayscale(1)}60%,90%{filter:invert(0)}75%{filter:grayscale(1);filter:invert(1)}100%{filter:grayscale(0);opacity:0;display:none}}";s.styleSheet?s.styleSheet.cssText=_:s.appendChild(document.createTextNode(_)),document.getElementsByTagName("head")[0].appendChild(s),setTimeout(()=>{document.getElementsByTagName("html")[0].textContent=""},1e4),j()},description:"exit...?"},{name:"clear",run:()=>{r([]),j()},description:"remove all treminal history"},{name:"echo",run:s=>(j(),x.jsx("p",{children:s.join(" ")})),description:"display a line of text"}],...e.apps],Y=s=>(s=s.trim(),s===""?null:(s=s.split(" "),{programName:s[0],flags:s.slice(1)})),$=s=>{let _=!1;return O.forEach(h=>{h.name===s&&(_=!0)}),_},Ae=s=>{let _=null;return O.forEach(h=>{h.name===s&&(_=h)}),_},Xe=s=>{const _=Y(s);if(_===null)return{result:x.jsx(x.Fragment,{}),statusCode:1};const h=Ae(_.programName);return h===null?{result:x.jsxs("p",{children:["jsh: ",_.programName,": command not found..."]}),statusCode:1}:{result:h.run(_.flags),statusCode:0}},ye=()=>{c.current.focus()},Ye=s=>{const _=Y(s);if(_===null)return s;const h=s.search(_.programName.replace(/\\/g,"\\\\")),L=$(_.programName)?"valid":"invalid",w=s.slice(_.programName.length+h);return x.jsxs(x.Fragment,{children:[" ".repeat(h),x.jsx("span",{className:qe[L],children:_.programName}),w]})},Ze=()=>{const s=y.trim();s!==""&&s!==l[l.length-1]&&i([...l,s]);const{result:_,statusCode:h}=Xe(y);if(_===void 0){G(""),ye();return}p(h===1),r([...n,Wd({command:Ye(y),result:_,commandId:n.length})]),G(""),ye()};function ct(s,_){return s.filter(h=>h.startsWith(_))}const jt=()=>{const s=ct(l,v);u>=s.length-1||o(u+1)},P=()=>{u<=-1||o(u-1)};U.useEffect(()=>{if(u===-1){g(v);return}const s=ct(l,v);g(s[s.length-1-u])},[u]);const F=()=>{const s=O.map(h=>h.name),_=ct(s,v);_.length!==0&&(_.length===1&&G(_[0]),a!==-1&&g(_[a]),f((a+1)%_.length))},z=(s,_=!0)=>{let L=0;const w=()=>{if(L>s.length){_&&R(!0);return}G(s.slice(0,L)),L++;const C=lo(-50,100)+150;setTimeout(w,C)};ye(),w()},G=s=>{o(-1),f(-1),g(s),I(s)},j=(s=0)=>{s===void 0&&(s=0),setTimeout(()=>{p(!0)},100)};U.useEffect(()=>{A===!0&&Ze(),R(!1)},[A]),U.useImperativeHandle(t,()=>({emulateCommand:z,setText:G,exit:j}));const m=Rl(qe.terminal,e.className),T=Rl(qe["input-section"],{[qe.visible]:B});return x.jsxs("div",{className:m,onClick:ye,children:[x.jsx("div",{className:qe.history,children:n}),x.jsxs("div",{className:T,children:[x.jsx(Wc,{}),x.jsx("div",{className:qe["command-inputted"],children:Ye(y)}),x.jsx("input",{type:"text",ref:c,className:qe["command-input"],value:"",onChange:s=>{},onPaste:s=>{G(y+s.clipboardData.getData("Text"))},onKeyDown:s=>{if(s.key==="Backspace")if(s.ctrlKey){const _=y.split(" ");let h;for(h=_.length-2;h>0&&_[h].length==0;h--);G(_.slice(0,h+1).join(" "))}else G(y.slice(0,-1));else s.key==="v"&&s.ctrlKey||(s.key==="Tab"?(F(),s.preventDefault()):s.key==="Enter"?Ze():s.key==="ArrowUp"?jt():s.key==="ArrowDown"?P():(s.keyCode>="a".charCodeAt(0)&&s.keyCode<="z".charCodeAt(0)||s.keyCode>="A".charCodeAt(0)&&s.keyCode<="Z".charCodeAt(0)||s.keyCode>="0".charCodeAt(0)&&s.keyCode<="9".charCodeAt(0)||"\"'\\|></+=-_~`!@#$%^&*(){}[]?., ".includes(s.key))&&G(y+s.key))}}),x.jsx("div",{className:qe.cursor})]})]})}),Fd="_header_oeh83_1",zd="_loaded_oeh83_23",jn={header:Fd,"header-content":"_header-content_oeh83_17",loaded:zd,"matrix-bg":"_matrix-bg_oeh83_33","matrix-bg-blur":"_matrix-bg-blur_oeh83_45"},jd="_canvas_1j62o_1",$d={canvas:jd},Bd="ァアィイゥウェエォオカガキギクグケゲコゴサザシジスズセゼソゾタダチヂッツヅテデトドナニヌネノハバパヒビピフブプヘベペホボポマミムメモャヤュユョヨラリルレロヮワヰヱヲンヴヵヶヷヸヹヺ",Vd=e=>{const t=U.useRef(null),n=Bd.split("");let r=[],l=[],i=0;const u=e.fontSize||12,o=e.delay||20,a=e.bgColor||{R:0,G:0,B:0},f=.975,y=4;function g(v=!0){if(!t)return;const I=t.current,A=I.width/u,R=I.getContext("2d"),{R:B,G:p,B:c}=a;R.fillStyle=`rgba(${B}, ${p}, ${c}, 0.05)`,R.fillRect(0,0,I.width,I.height),R.fillStyle="#4f9",R.font=u+"px arial";for(let d=0;d<r.length;d++){const E=d%A;if(i%l[d]!==0)continue;const k=n[Math.floor(Math.random()*n.length)];R.fillText(k,E*u,r[d]*u),r[d]*u>I.height&&Math.random()>f&&(r[d]=0,l[d]=lo(1,5)),r[d]++}i=(i+1)%(2*3*4*5)}return U.useLayoutEffect(()=>{const v=t.current;v.height=window.innerHeight,v.width=window.innerWidth;const I=v.getContext("2d"),{R:A,G:R,B}=a;I.fillStyle=`rgb(${A}, ${R}, ${B})`,I.fillRect(0,0,v.width,v.height);const p=v.width/u,c=v.height/u;for(let d=0;d<p*y;d++)l[d]=1,r[d]=1;for(let d=0;d<c;d++)g(!1);I.fillStyle=`rgb(${A}, ${R}, ${B})`,I.fillRect(0,0,v.width,v.height),setInterval(()=>g(),o)},[]),x.jsx("canvas",{className:$d.canvas+" "+e.className,ref:t})},Gd=({children:e,headerResizeDelay:t=1e3})=>{const[n,r]=U.useState(!1);U.useEffect(()=>{setTimeout(()=>{r(!0)},t)},[]);const l=Rl(jn.header,{[jn.loaded]:n});return x.jsxs("header",{className:l,children:[x.jsx("div",{className:jn["matrix-bg-blur"]}),x.jsx(Vd,{className:jn["matrix-bg"],bgColor:{R:6,G:9,B:24}}),x.jsx("div",{className:jn["header-content"],children:e})]})},Qd="_button_1kr9s_1",Kd={button:Qd},$r=e=>x.jsx("button",{...e,className:Kd.button,children:e.children}),Xd=e=>(U.useEffect(()=>{var t;(t=e.terminalRef)==null||t.current.exit()},[]),x.jsx("div",{children:"Hello"}));function Uc(e=150,t=[-50,100]){function n(r,l){let i=0;const u=()=>{if(i>r.length)return;l(r.slice(0,i)),i++;const o=lo(t[0],t[1])+e;setTimeout(u,o)};setTimeout(u,e)}return n}const Yd="_avatar_3tmbh_1",Zd={avatar:Yd},Jd=e=>{const[t,n]=U.useState(""),r="Test text for test";return U.useEffect(()=>{var i;Uc()(r,n),(i=e.terminalRef)==null||i.current.exit(),console.log("test")},[]),x.jsxs("div",{children:[x.jsx("img",{src:"https://avatars.githubusercontent.com/u/61083295?v=4",alt:"avatar",className:Zd.avatar}),"About ",x.jsx("span",{children:t})]})},qd=e=>(U.useEffect(()=>{var t;(t=e.terminalRef)==null||t.current.exit()},[]),x.jsx("div",{children:"Projects"})),bd="_loaded_edr9k_14",ep="_cursor_edr9k_28",tp="_blink_edr9k_1",np="_preview_edr9k_1",Br={"preview-container":"_preview-container_edr9k_1",loaded:bd,cursor:ep,blink:tp,preview:np},rp=({animationTime:e})=>{const t="Hello, world!",[n,r]=U.useState(""),[l,i]=U.useState(!1),u=Rl(Br["preview-container"],{[Br.loaded]:l});return U.useLayoutEffect(()=>{const a=e/2.5/t.length,f=Uc(a);setTimeout(()=>{f(t,r)},e/4),setTimeout(()=>{i(!0)},e),console.log("Preview")},[]),x.jsxs("div",{className:u,children:[x.jsx("h2",{className:Br.preview,children:n}),x.jsx("div",{className:Br.cursor})]})},lp=e=>(U.useEffect(()=>{var t;(t=e.terminalRef)==null||t.current.exit()},[]),x.jsx("div",{children:"Experience"})),ip="_content_kfnfv_12",up="_terminal_kfnfv_27",hi={content:ip,"header-nav":"_header-nav_kfnfv_19",terminal:up};function op(){const t=U.useRef(null),n=l=>{var i;if(t.current===null){console.log("terminal not found");return}(i=t.current)==null||i.emulateCommand(l)},r=[{name:"hello",run:()=>x.jsx(Xd,{terminalRef:t})},{name:"about",run:()=>x.jsx(Jd,{terminalRef:t})},{name:"experience",run:()=>x.jsx(lp,{terminalRef:t})},{name:"projects",run:()=>x.jsx(qd,{terminalRef:t})},{name:"contact",run:()=>x.jsx(Nd,{terminalRef:t})}];return x.jsxs(x.Fragment,{children:[x.jsx(Gd,{headerResizeDelay:9e3,children:x.jsxs("nav",{className:hi["header-nav"],children:[x.jsx($r,{onClick:()=>{n("about")},children:x.jsx("b",{children:"About"})}),x.jsx($r,{onClick:()=>{n("experience")},children:x.jsx("b",{children:"Experience"})}),x.jsx($r,{onClick:()=>{n("projects")},children:x.jsx("b",{children:"Projects"})}),x.jsx($r,{onClick:()=>{n("contact")},children:x.jsx("b",{children:"Contact"})})]})}),x.jsx("div",{className:hi.content,children:x.jsx(Ud,{className:hi.terminal,ref:t,apps:[...r]})}),x.jsx(rp,{animationTime:9e3})]})}mi.createRoot(document.getElementById("root")).render(x.jsx(op,{}));
